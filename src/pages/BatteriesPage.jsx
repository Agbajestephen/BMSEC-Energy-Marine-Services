...
const BatteriesPage = () => {
  const allProducts = getProductsByCategory('Batteries')
  ...
  const subcategories = getSubcategories('Batteries')
  ...
  return (
    <>
      <CategoryBanner
        ...
        description="Long-lasting batteries for cars, trucks, marine vessels, and industrial applications"
        image="https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=1920&q=80"
        breadcrumbs={[{ name: 'Products', link: '/products' }, { name: 'Batteries' }]}
      />
