...
const TiresPage = () => {
  const allProducts = getProductsByCategory('Tires')
  ...
  const subcategories = getSubcategories('Tires')
  ...
  return (
    <>
      <CategoryBanner
        title="Tires"
        subtitle="All Seasons, All Terrains"
        description="Top-brand tires for cars, trucks, SUVs, and performance vehicles with warranty coverage"
        image="https://images.unsplash.com/photo-1578844251758-2f71da64c96f?w=1920&q=80"
        breadcrumbs={[{ name: 'Products', link: '/products' }, { name: 'Tires' }]}
      />
